        ...
        >
          <div className="cursor-none">
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Countries We Served</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      LUMI AI has automated workflows, systems, and business operations across these countries.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="absolute top-64 z-10 flex items-center justify-center">
                    <div
                      ...
                      onMouseMove={(event) => {
                        ...
                        const countries = ["India", "UAE", "Saudi Arabia", "USA", "UK", "Australia", "Sri Lanka"]
                        const index = Math.min(countries.length - 1, Math.max(0, Math.floor(x * countries.length)))
                        setHoveredCountry(countries[index])
                      }}
                    >
                      <Suspense
                        fallback={
                      ...
                      >
                        <Earth
                          ...
                          dark={dark}
                          markers={[
                            { location: [20.5937, 78.9629], size: 0.06 }, // India
                            { location: [23.4241, 53.8478], size: 0.06 }, // UAE
                            { location: [23.8859, 45.0792], size: 0.06 }, // Saudi Arabia
                            { location: [37.0902, -95.7129], size: 0.06 }, // USA
                            { location: [55.3781, -3.436], size: 0.06 }, // UK
                            { location: [-25.2744, 133.7751], size: 0.06 }, // Australia
                            { location: [7.8731, 80.7718], size: 0.06 }, // Sri Lanka
                          ]}
                        />
                      </Suspense>
                      {hoveredCountry && (
                        <div className="pointer-events-none absolute bottom-6 left-1/2 -translate-x-1/2 rounded-full border border-white/10 bg-black/80 px-3 py-1 text-xs text-foreground shadow-lg">
                          {hoveredCountry}
                        </div>
                      )}
                    </div>
