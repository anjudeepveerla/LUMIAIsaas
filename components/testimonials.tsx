...
const TestimonialCard = ({
  ...
  return (
    <div 
      className="relative w-full max-w-xs overflow-hidden rounded-3xl p-10 group"
      style={{
    ...
    >
      ...
      <div className="relative z-10 text-white/90 leading-relaxed">{body}</div>

      <div className="mt-5 flex items-center gap-2 relative z-10">
        <img src={img || "/placeholder.svg"} alt={name} height="40" width="40" className="h-10 w-10 rounded-full border border-white/20" />
