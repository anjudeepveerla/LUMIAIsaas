          ...
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                ...
                <em className="italic font-serif font-light">Intelligent Innovation</em>
              </h1>
            </motion.div>
            ...
            >
              There's nothing you can't automate with LUMI AI. From voice agents to full-scale business automations—we
              help you save time, scale faster, and stay ahead of the curve.
            </motion.p>
